define(["require", "exports", "./xyTuple", "./DrawingHelper"], function (require, exports, xyTuple_1, DrawingHelper_1) {
    ...
    var CharacterAfterImage = /** @class */ (function () {
        ...
        CharacterAfterImage.prototype.draw = function (context) {
            ...
            DrawingHelper_1.drawImage(context, 'BODY', WALKING_STEPS[Math.floor(this.frame / WALKING_CONSTANT)], this.direction, this.position.x, this.position.y, size);
            DrawingHelper_1.drawImage(context, 'HEAD', 0, this.direction, this.position.x, this.position.y + this.headOffset, size);
            context.restore();
            // Count down
    ...
    var Character = /** @class */ (function () {
        ...
        Character.prototype.draw = function (context) {
            ...
            DrawingHelper_1.drawImage(context, 'HEAD', 0, this.velocity.direction, this.position.x, this.position.y + this.headOffset, size);
        };
        return Character;
    }());
